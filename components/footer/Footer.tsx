...
export default function Footer() {
  ...
  <p className="text-xs text-[#6b5b4b]">100% safe & encrypted checkout</p>
      ...
      <div className="flex flex-col items-center text-center group">
        ...
        <p className="text-xs text-[#6b5b4b]">crafted with premium fabrics</p>
      </div>
      <div className="flex flex-col items-center text-center group">
      ...
      <div className="flex flex-col items-center text-center group">
        <Award className="w-8 h-8 text-[#8b7b6b] mb-3 group-hover:scale-110 transition-transform duration-300" />
        <h3 className="font-semibold text-sm mb-1 text-[#1a1a1a]">
          QUALITY ASSURED
        </h3>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-14">
        ...
        {/* Bottom Bar - Professional Structure */}
    <div className="border-t border-[#e8e3dc] pt-8 mt-6">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-1 flex flex-col items-center gap-1">
              <p className="text-[#6b5b4b] text-xs xs:text-base font-light">
                © 2026 GR STYLES All rights reserved
              </p>
            </div>
          </div>
        </div>
